...
CO_NESTED = 16  # nested_scopes
CO_GENERATOR_ALLOWED = 0  # generators (obsolete, was 0x1000)
CO_FUTURE_DIVISION = 8192  # division
CO_FUTURE_ABSOLUTE_IMPORT = 16384  # perform absolute imports by default
CO_FUTURE_WITH_STATEMENT = 32768  # with statement
CO_FUTURE_PRINT_FUNCTION = 65536  # print function
CO_FUTURE_UNICODE_LITERALS = 131072  # unicode string literals
class _Feature:
